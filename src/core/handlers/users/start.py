...
from src.core.filters import BannedUserFilter
from src.core.keyboards import menu_kb
from src.core.services import add_only_back_button
...
async def cmd_back_to_home(call: CallbackQuery):
    ...
    await call.message.edit_text(
        "Вы вернулись в главное меню 🤸🏻", reply_markup=menu_kb(call.from_user.id)
    )
